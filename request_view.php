            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <span>
                        ...
                        echo isset($statusLabels[$request['status']]) ? $statusLabels[$request['status']] : '<span class="badge bg-secondary">不明</span>';
                        ?>
                    </span>
                </div>
                <div class="card-body">
                                ...
                                <div class="list-group-item">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            ...
                                            echo isset($statusLabels[$approval['status']]) ? $statusLabels[$approval['status']] : '';
                                            ?>
