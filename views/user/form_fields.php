...
<div class="mb-3">
    ...
    <?php $selectedOrganizationId = isset($primaryOrgId) ? (string)$primaryOrgId : (isset($user['organization_id']) ? (string)$user['organization_id'] : ''); ?>
    <select class="form-select" id="organization_id" name="organization_id"
        data-selected="<?php echo htmlspecialchars($selectedOrganizationId); ?>">
        <option value="">選択してください</option>
        <?php if (isset($organizations) && is_array($organizations)): ?>
            <?php foreach ($organizations as $organization): ?>
                <option value="<?php echo $organization['id']; ?>" <?php echo $selectedOrganizationId === (string)$organization['id'] ? 'selected' : ''; ?>>
