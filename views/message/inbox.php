        ...
        <div class="col-md-9 col-lg-10">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">受信トレイ <?php if ($unreadCount > 0): ?><span class="badge bg-danger"><?php echo $unreadCount; ?></span><?php endif; ?></h5>
                    <div>
                        <form class="d-inline-flex" action="<?php echo BASE_PATH; ?>/messages/inbox" method="get">
                            <select name="is_read" class="form-select form-select-sm me-2" onchange="this.form.submit()">
                                <option value="all" <?php echo ($filters['is_read'] === 'all') ? 'selected' : ''; ?>>すべて</option>
                                <option value="unread" <?php echo ($filters['is_read'] === 'unread') ? 'selected' : ''; ?>>未読</option>
                                <option value="read" <?php echo ($filters['is_read'] === 'read') ? 'selected' : ''; ?>>既読</option>
                            </select>
                        ...
                        <table class="table table-hover message-list mb-0">
                            ...
                            <tbody>
                                <?php if (empty($messages)): ?>
                                    <tr>
                                        <td colspan="6" class="text-center py-4">メッセージがありません</td>
                                    </tr>
                                <?php else: ?>
