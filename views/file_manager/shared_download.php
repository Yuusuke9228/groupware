...
$message = $message ?? tr_text('共有リンクが見つかりません。', 'Share link was not found.');
...
<div class="container py-5" style="max-width: 760px;">
    <div class="card shadow-sm">
        <div class="card-body p-4 p-md-5">
            <h1 class="h4 mb-3">
                <i class="fas fa-link me-2 text-primary"></i><?= htmlspecialchars(tr_text('共有ファイル', 'Shared file')) ?>
            </h1>
            ...
            <?php if ($status === 'ready' && $share): ?>
                <div class="border rounded p-3 mb-4 bg-light">
                    ...
                    <div class="mb-2"><strong><?= htmlspecialchars(tr_text('サイズ', 'Size')) ?>:</strong> <?= number_format((int)$share['file_size']) ?> bytes</div>
            ...
            <?php elseif ($status === 'password_required'): ?>
                ...
                <form method="post" class="d-flex gap-2 flex-wrap">
                    <input type="password" name="share_password" class="form-control" style="max-width: 320px;" placeholder="<?= htmlspecialchars(tr_text('共有パスワード', 'Share password')) ?>" required>
