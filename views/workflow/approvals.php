                ...
                <nav aria-label="Page navigation" class="mt-4">
                    <ul
                        ...
                        <li class="page-item <?php echo $currentPaginationPage <= 1 ? 'disabled' : ''; ?>">
                            <a class="page-link" href="<?php echo BASE_PATH . '/workflow/approvals?page=' . $prevPage . $suffix; ?>" data-page="<?php echo $prevPage; ?>" aria-label="Previous">
                                <span aria-hidden="true">&laquo;</span>
                            </a>
                        </li>
                        <?php for ($i = 1; $i <= (int)$totalPages; $i++): ?>
                            <li class="page-item <?php echo $i === $currentPaginationPage ? 'active' : ''; ?>">
                                <a class="page-link" href="<?php echo BASE_PATH . '/workflow/approvals?page=' . $i . $suffix; ?>" data-page="<?php echo $i; ?>"><?php echo $i; ?></a>
                            </li>
                        <?php endfor; ?>
                        ...
                        <li class="page-item <?php echo $currentPaginationPage >= (int)$totalPages ? 'disabled' : ''; ?>">
                            <a class="page-link" href="<?php echo BASE_PATH . '/workflow/approvals?page=' . $nextPage . $suffix; ?>" data-page="<?php echo $nextPage; ?>" aria-label="Next">
