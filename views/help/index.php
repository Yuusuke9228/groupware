    ...
    <div class="help-section" id="sec-home">
        <div class="help-card">
            ...
            <div class="help-card-body">
                ...
                <h4>社内システム入口</h4>
                <p>管理者が登録した社内システムへのリンクが、トップページ右側の「社内システム入口」に表示されます。勤怠、基幹システム、社内ポータル、外部SaaSなど、日常的に使うシステムへすばやく移動できます。</p>
                <ul>
                    <li>リンクは新しいタブ、または同じタブで開くよう管理者が設定できます。</li>
                    <li>表示順、アイコン、説明文も管理者が変更できます。</li>
                    <li>表示されていないリンクがある場合は、システム管理者へお問い合わせください。</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="help-card">
            ...
            <div class="help-card-body">
                ...
                <ul>
                    ...
                    <li><strong>ポータルリンク設定</strong> ― トップページの「社内システム入口」に表示するリンクの追加・編集・削除</li>
                </ul>
            </div>
        </div>
    </div>
